...
\begin{scope}	
    \begin{axis}[
		...
		\addplot+[ycomb,blue, mark options={black, mark size=1}] table [x={n}, y={xn}] {periodic_square_fs_samples_of_envilope_4t1.dat};
...
\begin{scope}[yshift=-3.5cm]	
    \begin{axis}[
		...
		\addplot+[red, smooth, mark=none] table [x={n}, y={xn}] {periodic_square_fs_samples_of_envilope_gen.dat};
		\addplot+[ycomb,blue, mark options={black, mark size=1}] table [x={n}, y={xn}] {periodic_square_fs_samples_of_envilope_8t1.dat};
...
\begin{scope}[yshift=-7cm]	
    \begin{axis}[
		...
		\addplot+[red, smooth, mark=none] table [x={n}, y={xn}] {periodic_square_fs_samples_of_envilope_gen.dat};
		\addplot+[ycomb,blue, mark options={black, mark size=1}] table [x={n}, y={xn}] {periodic_square_fs_samples_of_envilope_16t1.dat};
