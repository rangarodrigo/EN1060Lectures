...
\begin{scope}
	    ...
	    \draw[-latex] (0, -0.1) -- ++(0,3.5) node[anchor=south] {$x_3[n]$};
	    \foreach \x/\y in {-2/0, -1/0, 0/0, 1/1, 2/2, 3/0, 4/0}
	        {
    ...
    \end{scope}
	    ...
	    \draw[-latex] (0, -0.1) -- ++(0,3.5) node[anchor=south] {$y_3[n]$};
	   \foreach \x/\y in {-2/0, -1/0, 0/1, 1/2, 2/3, 3/1, 4/0}
	        {
	            \draw[fill=black] (\x*0.4, 0) -- ++(0,\y) circle (1pt);
	        }
