\begin{tikzpicture}
	\begin{scope}
	    \draw[-latex] (-3*0.4,0) -- (8*0.4,0) node[anchor=west] {$n$};
	    \draw[-latex] (0, -0.1) -- ++(0,3.5) node[anchor=south] {$x_1[n]$};
	    \foreach \x/\y in {-2/0, -1/0, -1/0, 0/1, 1/2, 2/3, 3/0, 4/0, 5/2, 6/2, 7/0}
	        {
    ...
    \end{scope}
	    ...
	    \draw[-latex] (0, -2.1) -- ++(0,5.5) node[anchor=south] {$x_2[n]$};
	    \foreach \x/\y in {-3/0, -2/-2, -1/-2, 0/2, 1/2, 2/0, 3/-2, 4/0}
	        {
	            \draw[fill=black] (\x*0.4, 0) -- ++(0,\y) circle (1pt);
	        }
