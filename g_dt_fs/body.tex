...
\begin{frame}{Discrete-Time Fourier Series}
    Consider the representation of more general preiodic sequences in terms of linear combination fo sequences $\phi_k[n]$
    \begin{equation*}
        x[n] = \sum_k \phi_k[n] =  \sum_k a_k e^{jk\omega_0 n} = \sum_k a_k e^{jk(2\pi/N) n},
    \end{equation*}
